...
# TIME STAMP SETTINGS
TIME_STAMP_FORMAT = %Y_%m_%d_%H_%M_%S

# PROXIMITY SENSOR SETTINGS
PROXIMITY_SENSOR_THRESHOLD_CM = 30.0
PROXIMITY_SENSOR_TRIGGER_PIN = YOUR_PROXIMITY_SENSOR_TRIGGER_PIN_NUMBER
PROXIMITY_SENSOR_ECHO_PIN = YOUR_PROXIMITY_SENSOR_ECHO_PIN_NUMBER
